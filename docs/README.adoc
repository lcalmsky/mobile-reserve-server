...
include::common/server-info.adoc[]

== 쿠폰 발급 APIs

include::post-coupon.adoc[]

== 쿠폰 조회 APIs

include::get-coupon.adoc[]
...
[source,bash]
----
$ asciidoctor README.adoc -a setanchors=true -a idseparator=- -a doctype=book -a docinfo1=true -a toclevels=3 -a sectanchors -a sectlinks -o coupon-api-v1.0.0.html
----
